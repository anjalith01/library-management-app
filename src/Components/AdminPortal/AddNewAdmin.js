        ...
        if (isValid) {
            ...
            try {
                ...
                const res = await fetch("http://localhost:8000/add-user", {
                    method: 'POST',
                    body: JSON.stringify({...formFields,isAdmin:true}),
                    headers: {
    ...
    return (
        <>
            ...
            <div className="container-fluid mt-5 px-4">
                <div className="mb-3">
                    <h3><span className="table-title">Add new admin</span></h3>
                </div>
                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-md-12">
                                    <button type="submit" className="action-button">{isLoading?<Loader/>:"Add Admin"}</button>
                                </div>
                            </div>
                        </div>
                    </div>
